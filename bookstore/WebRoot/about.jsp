...
<html>
<head>
<title>The Free Smart-Sale Website Template | About :: w3layouts</title>
	...
	<div class="menu">
        ...
        <li><a href="index.jsp" title="Home">Home</a></li>
  		...
  		<li><a href="contact.jsp">Contact</a></li>
  		 <li><a href="index.jsp">Subscribe</a></li>
	    <li><a href="index.jsp">Customer Support</a></li>
...
<div class="about">
		<div class="abt_para">
	    	 <a href="details.jsp"><h3>Lorem Ipsum is simply dummy text </h3></a>
			...
			<div class="btn top-right"><a href="details.jsp">View More</a></div>
		 </div>
		 <div class="abt_img">
			<a href="details.jsp"><img src="./images/pic1.jpg"></a>
		</div>
		<div class="clear"></div>
